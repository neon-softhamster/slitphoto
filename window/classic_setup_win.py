...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.slit_pos_text = QtWidgets.QLabel(Setup)
        self.slit_pos_text.setGeometry(QtCore.QRect(30, 620, 151, 51))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 881, 511))
